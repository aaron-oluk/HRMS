...
<div class="space-y-8">
    <div>
        ...
        <p class="mt-0.5 text-sm text-slate-500">Which entity this employee belongs to and their record status.</p>
    ...
    <div class="border-t border-slate-100 pt-6">
        ...
        <p class="mt-0.5 text-sm text-slate-500">The employee's legal name and personal information.</p>
        <div class="mt-4 grid grid-cols-1 gap-5 sm:grid-cols-2">
            <div>
    ...
    <div class="border-t border-slate-100 pt-6">
        <h3 class="text-sm font-semibold text-slate-900">Identification</h3>
        <p class="mt-0.5 text-sm text-slate-500">Government-issued identification and tax numbers.</p>
        <div class="mt-4 grid grid-cols-1 gap-5 sm:grid-cols-2">
            <div>
    ...
    <div class="border-t border-slate-100 pt-6">
        ...
        <p class="mt-0.5 text-sm text-slate-500">How to reach this employee outside of work systems.</p>
        <div class="mt-4 grid grid-cols-1 gap-5 sm:grid-cols-2">
            <div>
