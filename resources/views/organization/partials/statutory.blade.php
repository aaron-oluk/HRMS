<x-card class="max-w-3xl" x-data="{
    ...
    <div class="mb-6 border-b border-slate-100 pb-5">
        ...
        <p class="mt-1 text-sm text-slate-500">PAYE bands and NSSF rates used by your payroll runs. Changes apply to runs generated after saving.</p>
    </div>

    <form method="POST" action="{{ route('organization.update-statutory') }}">
        @csrf
        @method('PUT')
        ...
        <div class="mt-6 border-t border-slate-100 pt-6">
            ...
            <div class="mt-4 grid grid-cols-1 gap-5 sm:grid-cols-2">
                <div>
                    <x-label for="paye_surcharge_floor" value="Surcharge floor" />
