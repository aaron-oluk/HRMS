<x-layouts.admin title="Edit theme" header="Edit theme">
    <x-card class="max-w-3xl">
        <div class="mb-6 border-b border-slate-100 pb-5">
            <h2 class="text-base font-semibold text-slate-900">Edit theme</h2>
            <p class="mt-1 text-sm text-slate-500">Changes apply immediately to every company using this theme.</p>
        </div>
