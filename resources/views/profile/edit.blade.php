    ...
    <div x-data="{ tab: 'profile' }">
        <div class="border-b border-slate-200">
            <nav class="-mb-px flex gap-x-6">
                ...
                <button type="button" @click="tab = 'signature'" :class="tab === 'signature' ? 'border-emerald-600 text-emerald-600' : 'border-transparent text-slate-500 hover:text-slate-700'" class="flex items-center gap-x-1.5 border-b-2 px-1 py-3 text-sm font-medium">
                    <i class="bx bx-pen text-base"></i> My Signature
                </button>
        ...
        <div class="mt-6" x-show="tab === 'signature'" x-cloak>
            @include('profile.partials.signature')
        </div>
